...
def frame():
    ...
    canvas1.create_image(0, 0, image=bg,
                         anchor="nw")
    lable0 = tk.Label(root, text='Borrower Login', font=('Microsoft YaHei', 50)).place(x=300, y=100)
    ...
    tk.Button(root, text='Quit', font=('Microsoft YaHei', 15), width=10, height=2, command=exit_borrower).place(x=550, y=500)
    root.mainloop()
