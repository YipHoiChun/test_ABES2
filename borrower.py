...
def frame():
    ...
    lable0 = tk.Label(root, text='Borrower Login', bg='pink', font=('微软雅黑', 50)).pack()  # 上
    ...
    tk.Button(root, text='Quit', font=('微软雅黑', 15), width=10, height=2, command=exit_borrower).place(x=550, y=500)
    root.mainloop()
