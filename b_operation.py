...
def frame():
    ...
    lable1 = tk.Label(window2, text='Please select the operation:', font=('Microsoft YaHei', 20)).place(x=80, y=400)  # 下
...
def borrow():
    ...
    lable1 = tk.Label(win, text='Please fill in the information of the borrowed equipment:', bg='pink', font=('Microsoft YaHei', 20)).place(x=30, y=100)
    lable2 = tk.Label(win, text='(The equipment name should be filled in correctly!)', bg='pink', font=('Microsoft YaHei', 20)).place(x=30, y=140)
...
def turnback():  # 还书
    ...
    if result[0] == 0:
        ...
        lable1 = tk.Label(win, text='The following equipment on the unreturned：', bg='pink', font=('Microsoft YaHei', 20)).place(x=80, y=20)
        ...
        lable2 = tk.Label(win, text='Please enter your equipment return information：', bg='pink', font=('Microsoft YaHei', 20)).place(x=80, y=360)
        lable22 = tk.Label(win, text='The equipment name should be filled in correctly！', bg='pink', font=('Microsoft YaHei', 20)).place(x=80, y=400)
        global e_name
        tk.Label(win, text='Equipment：', font=('Microsoft YaHei', 12)).place(x=80, y=480)
        e_name = tk.Entry(win, font=('Microsoft YaHei', 12), width=10)
        e_name.place(x=180, y=480)

        tk.Button(win, text='Confirm Turn back', font=('Microsoft YaHei', 12), width=10, command=confirm_turnback).place(x=395, y=480)
    db.close()
...
def qrcode_show():
    ...
    tk.Button(win, text='Confirm Turn back', font=('Microsoft YaHei', 12), width=10, command=confirm_qrcode_borrow).place(x=600, y=195)
    win.mainloop()
