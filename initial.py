...
def frame():  # 初始界面
    ...
    lable0 = tk.Label(root, text='Welcome to ABES', bg='pink', font=('微软雅黑', 50)).pack()  # 上
    lable1 = tk.Label(root, text='Please select the user type:', font=('微软雅黑', 20)).place(x=80, y=200)  # 下
    ...
    tk.Button(root, text='Manager', font=('微软雅黑', 15), width=20, height=2, command=exit_manager).place(x=350, y=550)
