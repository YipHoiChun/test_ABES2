...
def frame():
    ...
    canvas1.create_image(0, 0, image=bg,
                         anchor="nw")
    lable1 = tk.Label(root, text='Please select the user type:', font=('Microsoft YaHei', 20)).place(x=80, y=100)  # 下
    ...
    lable2 = tk.Label(root, text='Student Borrow Equipment', font=('Microsoft YaHei', 25)).place(x=350, y=150)
    lable3 = tk.Label(root, text='Manager manage Equipment', font=('Microsoft YaHei', 23)).place(x=350, y=400)
